...
function sudaLogInit(in_uid){var win=window,doc=document,nav=navigator,ua=nav.userAgent,scr=win.screen,loc=win.location.href;var domain='beacon.sina.com.cn';var a_gif=prtl+domain+'/a.gif?',e_gif=prtl+domain+'/e.gif?';var uid='',webUrl=''
